...
function xguide(plt, idx=length(plt.subplots))
    return plt.subplots[idx].attr[:xaxis].plotattributes[:guide]
end
function yguide(plt, idx=length(plt.subplots))
    return plt.subplots[idx].attr[:yaxis].plotattributes[:guide]
end
function zguide(plt, idx=length(plt.subplots))
    return plt.subplots[idx].attr[:zaxis].plotattributes[:guide]
end
